 ...
 * {@code spring.datasource.password} fixture {@code ActuatorMaskingIntegrationTest} and
 * {@code UnmaskingDisabledIntegrationTest} check - a secret masks either way (selectively, via
...
@ActiveProfiles("test")
class ActuatorValuesMaskedOutsideLocalDevelopmentIntegrationTest {
