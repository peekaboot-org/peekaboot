 ...
 * opt-ins design (see {@code UnmaskingEnabledIntegrationTest} for the HTTP-level proof).
 ...
 * same reason {@code UnmaskingEnabledIntegrationTest} needs its own:
 ...
 * {@code DashboardTabsTest.configTabMasksSensitiveValues} for the masked-by-default half
 * of the same fixture).
 */
@SpringBootTest(
...
@ActiveProfiles("test")
class UnmaskingControlEnabledTest extends PlaywrightTestBase {
    ...
    void togglingTheControlRevealsAMaskedConfigValue() {
        ...
        assertThat(page.getAttribute("#config-unmask-slot .pk-unmask-toggle", "aria-pressed")).isEqualTo("false");

        page.click("#config-unmask-slot .pk-unmask-toggle");
        waitForConfigPasswordValue("test-fixture-password");

        assertThat(page.getAttribute("#config-unmask-slot .pk-unmask-toggle", "aria-pressed")).isEqualTo("true");
    }
    ...
    void togglingOnTheConfigTabAlsoRevealsTheEnvironmentTab() {
        ...
        // Matches DashboardTabsTest.environmentFilterHighlightsMatches: waiting for a
        ...
        assertThat(page.getAttribute("#env-unmask-slot .pk-unmask-toggle", "aria-pressed")).isEqualTo("true");
    }
    ...
    private void openConfigPasswordRow() {
        ...
        // DashboardTabsTest.configTabMasksSensitiveValues.
