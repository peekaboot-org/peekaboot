 ...
 * {@link UnmaskingControlEnabledTest} for the complementary case.
 */
class UnmaskingControlDisabledTest extends PlaywrightTestBase {
    ...
    void unmaskControlIsNotRenderedOnTheConfigTab() {
        ...
        assertThat(page.locator("#config-unmask-slot .pk-unmask-toggle").count()).isZero();
    }
}
